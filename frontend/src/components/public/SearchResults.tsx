      ...
      <div className="divide-y divide-gray-200">
        {results.map((result, index) => (
            ...
            {searchType === 'transaction' ? (
              // Transaction-specific layout
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <div className="text-sm font-medium text-gray-500 uppercase">Transaction ID</div>
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-gray-500 uppercase">Amount</div>
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-gray-500 uppercase">Timestamp</div>
